...
if not CHANNEL_USERNAME or not CHANNEL_INVITE_LINK:
    raise ValueError("🔴 CHANNEL_USERNAME و CHANNEL_INVITE_LINK يجب تحديدهما في ENV!")
...
**2. المسؤولية:**  
- المستخدم مسؤول عن جميع الأنشطة عبر حسابه.  
- البوت غير مسؤول عن أي خسائر مالية ناتجة عن سوء الاستخدام.
...
**4. الخصوصية:**  
- نحترم خصوصيتك ولا نشارك بياناتك مع أطراف ثالثة.
